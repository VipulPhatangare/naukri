...
if __name__ == "__main__":
    ...
    parser.add_argument("--srp-workers", type=int, default=5, help="SRP harvest workers (default: 5)")
    parser.add_argument("--detail-workers", type=int, default=5, help="Detail link workers (default: 5)")
