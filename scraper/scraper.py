...
if __name__ == "__main__":
    ...
    parser.add_argument("--srp-workers", type=int, default=10, help="SRP harvest workers (default: 10)")
    parser.add_argument("--detail-workers", type=int, default=10, help="Detail link workers (default: 10)")
